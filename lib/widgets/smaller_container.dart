...
class SmallerContainer extends StatefulWidget {
  ...
  @override
  State<SmallerContainer> createState() => _SmallerContainerState();
}

class _SmallerContainerState extends State<SmallerContainer> {
  bool isHover = false;
  @override
